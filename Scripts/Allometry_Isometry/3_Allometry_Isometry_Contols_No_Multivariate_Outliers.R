...
Right_Pallidum_model_COntrols <- lmer(Right_Pallidum_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
Right_Pallidum_model_Controls_no_uni_out <- lmer(Right_Pallidum_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_Pallidum_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  

Right_Pallidum_no_outliers <- Right_Pallidum_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_Pallidum_model_no_outliers <- lmer(Right_Pallidum_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                         + (1|SITE_ID2), Right_Pallidum_no_outliers)

summary(Right_Pallidum_model_no_outliers)$coefficients 
p.adjust(summary(Right_Pallidum_model_no_outliers)$coefficients[,5], method = 'fdr') 

Right_Pallidum_model_no_outliers_coef <- summary(Right_Pallidum_model_no_outliers)$coefficients[2]
...
Right_Putamen_model_COntrols <- lmer(Right_Putamen_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                     + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Right_Putamen_model_Controls_no_uni_out <- lmer(Right_Putamen_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_Putamen_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Right_Putamen_Outlier_DF_C[influential, ]))

Right_Putamen_no_outliers <- Right_Putamen_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_Putamen_model_no_outliers <- lmer(Right_Putamen_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                        + (1|SITE_ID2), Right_Putamen_no_outliers)

summary(Right_Putamen_model_no_outliers)$coefficients 
p.adjust(summary(Right_Putamen_model_no_outliers)$coefficients[,5], method = 'fdr') 

Right_Putamen_model_no_outliers_coef <- summary(Right_Putamen_model_no_outliers)$coefficients[2]
...
Left_Pallidum_model_COntrols <- lmer(Left_Pallidum_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                     + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_Pallidum_model_Controls_no_uni_out <- lmer(Left_Pallidum_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_Pallidum_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  

Left_Pallidum_no_outliers <- Left_Pallidum_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_Pallidum_model_no_outliers <- lmer(Left_Pallidum_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                        + (1|SITE_ID2), Left_Pallidum_no_outliers)

summary(Left_Pallidum_model_no_outliers)$coefficients 
p.adjust(summary(Left_Pallidum_model_no_outliers)$coefficients[,5], method = 'fdr') 

Left_Pallidum_model_no_outliers_coef <- summary(Left_Pallidum_model_no_outliers)$coefficients[2]
...
names(CI_Left_Pallidum_TBV)[1] <- "Area"
...
Left_Putamen_model_COntrols <- lmer(Left_Putamen_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                    + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_Putamen_model_Controls_no_uni_out <- lmer(Left_Putamen_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_Putamen_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Left_Putamen_Outlier_DF_C[influential, ]))

Left_Putamen_no_outliers <- Left_Putamen_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_Putamen_model_no_outliers <- lmer(Left_Putamen_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                       + (1|SITE_ID2), Left_Putamen_no_outliers)

summary(Left_Putamen_model_no_outliers)$coefficients 
p.adjust(summary(Left_Putamen_model_no_outliers)$coefficients[,5], method = 'fdr') 

Left_Putamen_model_no_outliers_coef <- summary(Left_Putamen_model_no_outliers)$coefficients[2]
...
Right_Caudate_model_COntrols <- lmer(Right_Caudate_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                     + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Right_Caudate_model_Controls_no_uni_out <- lmer(Right_Caudate_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_Caudate_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  

Right_Caudate_no_outliers <- Right_Caudate_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_Caudate_model_no_outliers <- lmer(Right_Caudate_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                        + (1|SITE_ID2), Right_Caudate_no_outliers)

summary(Right_Caudate_model_no_outliers)$coefficients 
p.adjust(summary(Right_Caudate_model_no_outliers)$coefficients[,5], method = 'fdr') 

Right_Caudate_model_no_outliers_coef <- summary(Right_Caudate_model_no_outliers)$coefficients[2]
...
Right_Amygdala_model_COntrols <- lmer(Right_Amygdala_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                      + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Right_Amygdala_model_Controls_no_uni_out <- lmer(Right_Amygdala_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_Amygdala_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Right_Amygdala_Outlier_DF_C[influential, ]))

Right_Amygdala_no_outliers <- Right_Amygdala_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_Amygdala_model_no_outliers <- lmer(Right_Amygdala_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                         + (1|SITE_ID2), Right_Amygdala_no_outliers)

summary(Right_Amygdala_model_no_outliers)$coefficients 
p.adjust(summary(Right_Amygdala_model_no_outliers)$coefficients[,5], method = 'fdr') 

Right_Amygdala_model_no_outliers_coef <- summary(Right_Amygdala_model_no_outliers)$coefficients[2]
...
Right_Thalamus_Proper_model_COntrols <- lmer(Right_Thalamus_Proper_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                             + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Right_Thalamus_Proper_model_Controls_no_uni_out <- lmer(Right_Thalamus_Proper_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_Thalamus_Proper_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  

Right_Thalamus_Proper_no_outliers <- Right_Thalamus_Proper_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_Thalamus_Proper_model_no_outliers <- lmer(Right_Thalamus_Proper_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                                + (1|SITE_ID2), Right_Thalamus_Proper_no_outliers)

summary(Right_Thalamus_Proper_model_no_outliers)$coefficients 
p.adjust(summary(Right_Thalamus_Proper_model_no_outliers)$coefficients[,5], method = 'fdr') 

Right_Thalamus_Proper_model_no_outliers_coef <- summary(Right_Thalamus_Proper_model_no_outliers)$coefficients[2]
...
Right_Hippocampus_model_COntrols <- lmer(Right_Hippocampus_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                         + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Right_Hippocampus_model_Controls_no_uni_out <- lmer(Right_Hippocampus_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_Hippocampus_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Right_Hippocampus_Outlier_DF_C[influential, ]))

Right_Hippocampus_no_outliers <- Right_Hippocampus_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_Hippocampus_model_no_outliers <- lmer(Right_Hippocampus_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
...
Right_Hippocampus_model_no_outliers_coef <- summary(Right_Hippocampus_model_no_outliers)$coefficients[2]
...
Left_Thalamus_Proper_model_COntrols <- lmer(Left_Thalamus_Proper_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                            + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_Thalamus_Proper_model_Controls_no_uni_out <- lmer(Left_Thalamus_Proper_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_Thalamus_Proper_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  

Left_Thalamus_Proper_no_outliers <- Left_Thalamus_Proper_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_Thalamus_Proper_model_no_outliers <- lmer(Left_Thalamus_Proper_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                               + (1|SITE_ID2), Left_Thalamus_Proper_no_outliers)

summary(Left_Thalamus_Proper_model_no_outliers)$coefficients 
p.adjust(summary(Left_Thalamus_Proper_model_no_outliers)$coefficients[,5], method = 'fdr') 

Left_Thalamus_Proper_model_no_outliers_coef <- summary(Left_Thalamus_Proper_model_no_outliers)$coefficients[2]
...
names(CI_Left_Thalamus_Proper_TBV)[1] <- "Area"
...
Left_Hippocampus_model_COntrols <- lmer(Left_Hippocampus_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                        + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_Hippocampus_model_Controls_no_uni_out <- lmer(Left_Hippocampus_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_Hippocampus_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Left_Hippocampus_Outlier_DF_C[influential, ]))

Left_Hippocampus_no_outliers <- Left_Hippocampus_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_Hippocampus_model_no_outliers <- lmer(Left_Hippocampus_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                           + (1|SITE_ID2), Left_Hippocampus_no_outliers)

summary(Left_Hippocampus_model_no_outliers)$coefficients 
p.adjust(summary(Left_Hippocampus_model_no_outliers)$coefficients[,5], method = 'fdr') 

Left_Hippocampus_model_no_outliers_coef <- summary(Left_Hippocampus_model_no_outliers)$coefficients[2]
...
Left_Caudate_model_COntrols <- lmer(Left_Caudate_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                    + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_Caudate_model_Controls_no_uni_out <- lmer(Left_Caudate_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_Caudate_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  

Left_Caudate_no_outliers <- Left_Caudate_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_Caudate_model_no_outliers <- lmer(Left_Caudate_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                       + (1|SITE_ID2), Left_Caudate_no_outliers)

summary(Left_Caudate_model_no_outliers)$coefficients 
p.adjust(summary(Left_Caudate_model_no_outliers)$coefficients[,5], method = 'fdr') 

Left_Caudate_model_no_outliers_coef <- summary(Left_Caudate_model_no_outliers)$coefficients[2]
...
Right_Ventral_DC_model_COntrols <- lmer(Right_Ventral_DC_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                        + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Right_Ventral_DC_model_Controls_no_uni_out <- lmer(Right_Ventral_DC_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_Ventral_DC_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  

Right_Ventral_DC_no_outliers <- Right_Ventral_DC_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_Ventral_DC_model_no_outliers <- lmer(Right_Ventral_DC_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                           + (1|SITE_ID2), Right_Ventral_DC_no_outliers)

summary(Right_Ventral_DC_model_no_outliers)$coefficients 
p.adjust(summary(Right_Ventral_DC_model_no_outliers)$coefficients[,5], method = 'fdr') 

Right_Ventral_DC_model_no_outliers_coef <- summary(Right_Ventral_DC_model_no_outliers)$coefficients[2]
...
Right_Cerebellum_Cortex_model_COntrols <- lmer(Right_Cerebellum_Cortex_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                               + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Right_Cerebellum_Cortex_model_Controls_no_uni_out <- lmer(Right_Cerebellum_Cortex_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_Cerebellum_Cortex_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Right_Cerebellum_Cortex_Outlier_DF_C[influential, ]))

Right_Cerebellum_Cortex_no_outliers <- Right_Cerebellum_Cortex_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_Cerebellum_Cortex_model_no_outliers <- lmer(Right_Cerebellum_Cortex_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                                  + (1|SITE_ID2), Right_Cerebellum_Cortex_no_outliers)

summary(Right_Cerebellum_Cortex_model_no_outliers)$coefficients 
p.adjust(summary(Right_Cerebellum_Cortex_model_no_outliers)$coefficients[,5], method = 'fdr') 

Right_Cerebellum_Cortex_model_no_outliers_coef <- summary(Right_Cerebellum_Cortex_model_no_outliers)$coefficients[2]
...
Left_Ventral_DC_model_COntrols <- lmer(Left_Ventral_DC_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                       + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_Ventral_DC_model_Controls_no_uni_out <- lmer(Left_Ventral_DC_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_Ventral_DC_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  

Left_Ventral_DC_no_outliers <- Left_Ventral_DC_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_Ventral_DC_model_no_outliers <- lmer(Left_Ventral_DC_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                          + (1|SITE_ID2), Left_Ventral_DC_no_outliers)

summary(Left_Ventral_DC_model_no_outliers)$coefficients 
p.adjust(summary(Left_Ventral_DC_model_no_outliers)$coefficients[,5], method = 'fdr') 

Left_Ventral_DC_model_no_outliers_coef <- summary(Left_Ventral_DC_model_no_outliers)$coefficients[2]
...
Left_Cerebellum_Cortex_model_COntrols <- lmer(Left_Cerebellum_Cortex_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                              + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_Cerebellum_Cortex_model_Controls_no_uni_out <- lmer(Left_Cerebellum_Cortex_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_Cerebellum_Cortex_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Left_Cerebellum_Cortex_Outlier_DF_C[influential, ]))

Left_Cerebellum_Cortex_no_outliers <- Left_Cerebellum_Cortex_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_Cerebellum_Cortex_model_no_outliers <- lmer(Left_Cerebellum_Cortex_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                                 + (1|SITE_ID2), Left_Cerebellum_Cortex_no_outliers)

summary(Left_Cerebellum_Cortex_model_no_outliers)$coefficients 
p.adjust(summary(Left_Cerebellum_Cortex_model_no_outliers)$coefficients[,5], method = 'fdr') 

Left_Cerebellum_Cortex_model_no_outliers_coef <- summary(Left_Cerebellum_Cortex_model_no_outliers)$coefficients[2]
...
Left_Amygdala_model_COntrols <- lmer(Left_Amygdala_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                     + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_Amygdala_model_Controls_no_uni_out <- lmer(Left_Amygdala_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_Amygdala_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Left_Amygdala_Outlier_DF_C[influential, ]))

Left_Amygdala_no_outliers <- Left_Amygdala_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_Amygdala_model_no_outliers <- lmer(Left_Amygdala_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                        + (1|SITE_ID2), Left_Amygdala_no_outliers)

summary(Left_Amygdala_model_no_outliers)$coefficients 
p.adjust(summary(Left_Amygdala_model_no_outliers)$coefficients[,5], method = 'fdr') 

Left_Amygdala_model_no_outliers_coef <- summary(Left_Amygdala_model_no_outliers)$coefficients[2]
...
Right_Accumbens_Area_model_COntrols <- lmer(Right_Accumbens_Area_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                            + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Right_Accumbens_Area_model_Controls_no_uni_out <- lmer(Right_Accumbens_Area_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_Accumbens_Area_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Right_Accumbens_Area_Outlier_DF_C[influential, ]))

Right_Accumbens_Area_no_outliers <- Right_Accumbens_Area_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_Accumbens_Area_model_no_outliers <- lmer(Right_Accumbens_Area_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                               + (1|SITE_ID2), Right_Accumbens_Area_no_outliers)

summary(Right_Accumbens_Area_model_no_outliers)$coefficients 
p.adjust(summary(Right_Accumbens_Area_model_no_outliers)$coefficients[,5], method = 'fdr') 
Right_Accumbens_Area_model_no_outliers_coef <- summary(Right_Accumbens_Area_model_no_outliers)$coefficients[2]
...
Left_Accumbens_Area_model_COntrols <- lmer(Left_Accumbens_Area_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                           + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_Accumbens_Area_model_Controls_no_uni_out <- lmer(Left_Accumbens_Area_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_Accumbens_Area_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
#View(head(Left_Accumbens_Area_Outlier_DF_C[influential, ]))

Left_Accumbens_Area_no_outliers <- Left_Accumbens_Area_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_Accumbens_Area_model_no_outliers <- lmer(Left_Accumbens_Area_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                              + (1|SITE_ID2), Left_Accumbens_Area_no_outliers)

summary(Left_Accumbens_Area_model_no_outliers)$coefficients 
p.adjust(summary(Left_Accumbens_Area_model_no_outliers)$coefficients[,5], method = 'fdr') 

library(simr)
#Left_Accumbens_Area_model_power_sim <- powerSim(Left_Accumbens_Area_model_no_outliers,
test = fixed("Total_Brain_Vol_log", "sa"))
Left_Accumbens_Area_model_power_sim

Left_Accumbens_Area_model_no_outliers_coef <- summary(Left_Accumbens_Area_model_no_outliers)$coefficients[2]
...
Left_CortexVol_model_COntrols <- lmer(Left_CortexVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                      + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Left_CortexVol_model_Controls_no_uni_out <- lmer(Left_CortexVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Left_CortexVol_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Left_CortexVol_Outlier_DF_C[influential, ]))

Left_CortexVol_no_outliers <- Left_CortexVol_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Left_CortexVol_model_no_outliers <- lmer(Left_CortexVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                         + (1|SITE_ID2), Left_CortexVol_no_outliers)

summary(Left_CortexVol_model_no_outliers)$coefficients 
p.adjust(summary(Left_CortexVol_model_no_outliers)$coefficients[,5], method = 'fdr') 

Left_CortexVol_model_no_outliers_coef <- summary(Left_CortexVol_model_no_outliers)$coefficients[2]
...
row.names(Left_CortexVol_model_no_outliers_coef_DF) <- "Left Cortex"
...
CI_Left_CortexVol_TBV$Area <- "Left Cortex"
...
row.names(Left_CortexVol_Isometry_Test_Tidy_Coef) <- "Left Cortex"
...
Right_CortexVol_model_COntrols <- lmer(Right_CortexVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                       + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Right_CortexVol_model_Controls_no_uni_out <- lmer(Right_CortexVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Right_CortexVol_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
Right_CortexVol_no_outliers <- Right_CortexVol_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Right_CortexVol_model_no_outliers <- lmer(Right_CortexVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                          + (1|SITE_ID2), Right_CortexVol_no_outliers)

summary(Right_CortexVol_model_no_outliers)$coefficients 
p.adjust(summary(Right_CortexVol_model_no_outliers)$coefficients[,5], method = 'fdr') 

Right_CortexVol_model_no_outliers_coef <- summary(Right_CortexVol_model_no_outliers)$coefficients[2]
...
row.names(Right_CortexVol_model_no_outliers_coef_DF) <- "Right Cortex"
...
CI_Right_CortexVol_TBV$Area <- "Right Cortex"
...
row.names(Right_CortexVol_Isometry_Test_Tidy_Coef) <- "Right Cortex"
...
CorticalWhiteMatterVol_model_COntrols <- lmer(CorticalWhiteMatterVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                              + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
CorticalWhiteMatterVol_model_Controls_no_uni_out <- lmer(CorticalWhiteMatterVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(CorticalWhiteMatterVol_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  

CorticalWhiteMatterVol_no_outliers <- CorticalWhiteMatterVol_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
CorticalWhiteMatterVol_model_no_outliers <- lmer(CorticalWhiteMatterVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                                 + (1|SITE_ID2), CorticalWhiteMatterVol_no_outliers)

summary(CorticalWhiteMatterVol_model_no_outliers)$coefficients 
p.adjust(summary(CorticalWhiteMatterVol_model_no_outliers)$coefficients[,5], method = 'fdr') 

CorticalWhiteMatterVol_model_no_outliers_coef <- summary(CorticalWhiteMatterVol_model_no_outliers)$coefficients[2]
...
TotalGrayVol_model_COntrols <- lmer(TotalGrayVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                    + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
TotalGrayVol_model_Controls_no_uni_out <- lmer(TotalGrayVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(TotalGrayVol_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(TotalGrayVol_Outlier_DF_C[influential, ]))

TotalGrayVol_no_outliers <- TotalGrayVol_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
TotalGrayVol_model_no_outliers <- lmer(TotalGrayVol_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                       + (1|SITE_ID2), TotalGrayVol_no_outliers)

summary(TotalGrayVol_model_no_outliers)$coefficients 
p.adjust(summary(TotalGrayVol_model_no_outliers)$coefficients[,5], method = 'fdr') 

TotalGrayVol_model_no_outliers_coef <- summary(TotalGrayVol_model_no_outliers)$coefficients[2]
...
Brain_Stem_model_COntrols <- lmer(Brain_Stem_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
                                  + (1|SITE_ID2), Abide_Jong_Controls_No_Comorbidity)
...
#### 1. Removal of univariate outliers analyses 
Brain_Stem_model_Controls_no_uni_out <- lmer(Brain_Stem_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication 
...
## UNIVARIATE OUTLIERS 
cooksd <- cooks.distance(Brain_Stem_model_Controls_no_uni_out)
influential <- as.numeric(names(cooksd)[(cooksd > 5*mean(cooksd, na.rm=T))])  
View(head(Brain_Stem_Outlier_DF_C[influential, ]))

Brain_Stem_no_outliers <- Brain_Stem_Outlier_DF_C[-influential,]

# 3. Run model without univariate and mutivariate outliers and comorbidity 
Brain_Stem_model_no_outliers <- lmer(Brain_Stem_log~ Total_Brain_Vol_log + AGE_AT_SCAN*SEX + Medication
                                     + (1|SITE_ID2), Brain_Stem_no_outliers)

summary(Brain_Stem_model_no_outliers)$coefficients 
p.adjust(summary(Brain_Stem_model_no_outliers)$coefficients[,5], method = 'fdr') 

Brain_Stem_model_no_outliers_coef <- summary(Brain_Stem_model_no_outliers)$coefficients[2]
...
sink("CSV/LMEM_Jong_List_No_Outliers_Controls.csv")
